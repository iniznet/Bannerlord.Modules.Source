...
namespace TaleWorlds.CampaignSystem.Encounters
{
	public class PlayerEncounter
	{
		...
		public static void StartSiegeAmbushMission()
		{
			...
			Debug.FailedAssert("Siege state is invalid!", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "StartSiegeAmbushMission", 2226);
		}
		...
		public float GetPlayerStrengthRatioInEncounter()
		{
			...
			foreach (MobileParty mobileParty in list)
			{
				...
				{
					Debug.FailedAssert("Player side party null", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "GetPlayerStrengthRatioInEncounter", 2338);
				}
			}
			foreach (MobileParty mobileParty2 in list2)
			{
				...
				{
					Debug.FailedAssert("Opponent side party null", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Encounters\\PlayerEncounter.cs", "GetPlayerStrengthRatioInEncounter", 2350);
				}
			}
			if (num2 <= 0f)
			{
