...
namespace SandBox.CampaignBehaviors
{
	public class GuardsCampaignBehavior : CampaignBehaviorBase
	{
		...
		protected void AddDialogs(CampaignGameStarter campaignGameStarter)
		{
			...
			campaignGameStarter.AddPlayerLine("prison_guard_ask_prisoner_talk", "prison_guard_talk", "prison_guard_visit_prison", "{=EGI6ztlH}I want to speak with a prisoner.", null, null, 100, null, null);
			...
			campaignGameStarter.AddPlayerLine("prison_guard_visit_prison_ask_answer_3", "prison_guard_visit_prison_ask_for_permission_answer_options", "close_window", "{=D33fIGQe}Never mind.", null, null, 100, null, null);
			...
			campaignGameStarter.AddPlayerLine("prison_guard_visit_empty_prison", "prison_guard_visit_prison_nobody_2", "close_window", "{=b3KFoJJ8}All right then. I'll have a look at the prison.", null, null, 100, null, null);
			...
			campaignGameStarter.AddPlayerLine("prison_guard_not_visit_empty_prison", "prison_guard_visit_prison_nobody_2", "close_window", "{=L5vAhxhO}I have more important business to do.", null, null, 100, null, null);
			...
			campaignGameStarter.AddPlayerLine("player_ask_for_permission_to_enter_lords_hall", "castle_guard_talk", "close_window", "{=never_mind}Never mind.", null, null, 100, null, null);
