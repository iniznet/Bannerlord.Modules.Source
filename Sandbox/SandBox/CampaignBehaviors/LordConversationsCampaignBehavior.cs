...
namespace SandBox.CampaignBehaviors
{
	public class LordConversationsCampaignBehavior : CampaignBehaviorBase
	{
		...
		private bool PlayerIsBesieging()
		{
			...
			{
				return Settlement.CurrentSettlement.SiegeEvent.BesiegerCamp.GetInvolvedPartiesForEventType(5).Any((PartyBase party) => party.MobileParty == Hero.MainHero.PartyBelongedTo);
			}
			return false;
		}
		...
		protected void AddDialogs(CampaignGameStarter starter)
		{
			...
			starter.AddDialogLine("parley", "start", "lord_start", "{=!}{STR_PARLEY_COMMENT}", new ConversationSentence.OnConditionDelegate(this.conversation_siege_parley_met_on_condition), null, 100, null);
			...
			this.AddCaravanConversations(starter);
			...
			starter.AddDialogLine("lord_ask", "lord_start", "hero_main_options", "{=!}{COMMENT_STRING}", new ConversationSentence.OnConditionDelegate(this.conversation_lord_makes_comment_on_condition), null, 100, null);
			starter.AddDialogLine("lord_ask", "lord_start", "player_responds_to_surrender_demand", "{=!}{SURRENDER_DEMAND_STRING}", new ConversationSentence.OnConditionDelegate(this.conversation_lord_makes_surrender_demand_on_condition), null, 100, null);
			starter.AddDialogLine("hero_ask", "lord_start", "hero_main_options", "{=7bBfNRVS}So, then. What is it?", null, null, 100, null);
			starter.AddDialogLine("lord_ask", "lord_demands_surrender_after_comment", "player_responds_to_surrender_demand", "{=!}{MINOR_FACTION_SURRENDER_DEMAND_STRING}[ib:agressive]", new ConversationSentence.OnConditionDelegate(this.conversation_minor_faction_makes_surrender_demand_on_condition), null, 100, null);
			starter.AddDialogLine("lord_ask", "lord_demands_surrender_after_comment", "player_responds_to_surrender_demand", "{=!}{SURRENDER_DEMAND_STRING}", new ConversationSentence.OnConditionDelegate(this.conversation_lord_makes_surrender_demand_on_condition), null, 100, null);
		...
		private void AddOtherConversations(CampaignGameStarter starter)
		{
			...
			starter.AddDialogLine("talk_defeated_lord_release_return", "defeat_lord_answer_2", "close_window", "{=XugcHyLy}{DEFEAT_LORD_ANSWER}", null, null, 100, null);
			...
			starter.AddDialogLine("vassalage_offer_rejected", "lord_ask_enter_service_vassalage", "lord_pretalk", "{=tj4ebDmd}{VASSALAGE_REJECTION}[ib:closed]", new ConversationSentence.OnConditionDelegate(this.conversation_reject_vassalage_on_condition), null, 100, null);
		...
		public void conversation_player_children_marriage_list_options_on_consequence()
		{
			...
			if (!Extensions.IsEmpty<Hero>(adultChildrenSuitableForMarriage2) && !Extensions.IsEmpty<Hero>(adultChildrenSuitableForMarriage2))
			{
		...
		private void AddPoliticsAndBarter(CampaignGameStarter starter)
		{
			...
			starter.AddPlayerLine("player_want_to_end_mercenary_service", "lord_talk_speak_diplomacy_2", "lord_ask_exit_service", "{=LVX2x6Jf}I would like to end my contract with the {FACTION_NAME}.", new ConversationSentence.OnConditionDelegate(this.conversation_player_want_to_end_service_as_mercenary_on_condition), null, 100, null, null);
			...
			starter.AddPlayerLine("player_want_to_hire_mercenary", "lord_talk_speak_diplomacy_2", "player_ask_mercenary_to_join", "{=6eHl9Tz4}I would like you to serve {FACTION_NAME} as mercenary.", new ConversationSentence.OnConditionDelegate(this.conversation_player_want_to_hire_mercenary_on_condition), null, 100, null, null);
			...
			starter.AddDialogLine("barter_decision_thinking", "lord_post_barter", "lord_pretalk", "{=!}{BARTER_CONCLUSION_LINE}", null, null, 100, null);
			...
			starter.AddDialogLine("lord_considers_barter", "lord_considers_barter", "lord_barter_pre_decision", "{=anrenBiB}I am listening.", new ConversationSentence.OnConditionDelegate(this.conversation_can_lord_barter), null, 100, null);
			starter.AddDialogLine("lord_refuses_barter", "lord_considers_barter", "lord_start", "{=3L8xN9uC}I believe it hasn't been long since we've last bartered.", null, null, 100, null);
		...
		private void AddCaravanConversations(CampaignGameStarter starter)
		{
			...
			starter.AddPlayerLine("caravan_create_conversation_10", "magistrate_form_a_caravan_big_player_answer", "lord_pretalk", "{=2mJjDTAZ}That sounds expensive.", new ConversationSentence.OnConditionDelegate(this.conversation_magistrate_form_a_big_caravan_reject_on_condition), null, 100, null, null);
		...
		private void AddIntroductions(CampaignGameStarter starter)
		{
			...
			starter.AddDialogLine("gangleader_introduction_3", "lord_introduction", "lord_start", "{=iJd59BPZ}I'm {CONVERSATION_HERO.FIRSTNAME}. Ask around about me. You'll be told I keep the peace in the back alleys.[ib:warrior]", new ConversationSentence.OnConditionDelegate(this.conversation_default_gangleader_introduction_on_condition), null, 100, null);
		...
		private void AddWandererConversations(CampaignGameStarter starter)
		{
			...
			starter.AddPlayerLine("wanderer_meet_player_response1", "wanderer_player_reaction", "wanderer_introduction_d", "{=!}{BACKSTORY_RESPONSE_1}", null, null, 100, null, null);
			starter.AddPlayerLine("wanderer_meet_player_response2", "wanderer_player_reaction", "wanderer_introduction_d", "{=!}{BACKSTORY_RESPONSE_2}", null, null, 100, null, null);
			...
			starter.AddDialogLine("wanderer_job_status_1", "wanderer_job_status", "hero_main_options", "{=HVdZI3C1}Right now I'm working for {EMPLOYER}.", new ConversationSentence.OnConditionDelegate(this.conversation_wanderer_job_status_on_condition), null, 100, null);
		...
		private void AddAnimationTestConversations(CampaignGameStarter starter)
		{
			...
			starter.AddDialogLine("lord_animation", "lord_animation_tests", "lord_animation_tests_select", "{=!}Which ones?.", () => Game.Current.IsDevelopmentMode, null, 100, null);
			starter.AddPlayerLine("lord_animation", "lord_animation_tests_select", "lord_pretalk", "{=!}We're done. Go back.", () => Game.Current.IsDevelopmentMode, null, 100, null, null);
			...
			starter.AddDialogLine("lord_expression_test_bared_teeth", "lord_expression_test_bared_teeth", "lord_test_expressions", "{=!}(uses convo_bared_teeth)[if:convo_bared_teeth]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_dismayed", "lord_expression_test_dismayed", "lord_test_expressions", "{=!}(uses convo_dismayed)[if:convo_dismayed]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_aggressive", "lord_expression_test_aggressive", "lord_test_expressions", "{=!}(uses convo_aggressive)[if:convo_aggressive]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_predatory", "lord_expression_test_predatory", "lord_test_expressions", "{=!}(uses convo_predatory)[if:convo_predatory]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_insulted", "lord_expression_test_insulted", "lord_test_expressions", "{=!}(Insulted face)[if:convo_insulted]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_angry", "lord_expression_test_angry", "lord_test_expressions", "{=!}(angry face)[if:convo_angry]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_furious", "lord_expression_test_furious", "lord_test_expressions", "{=!}(Furious face)[if:convo_furious]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_annoyed", "lord_expression_test_annoyed", "lord_test_expressions", "{=!}(annoyed face)[if:convo_annoyed]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_confused_annoyed", "lord_expression_test_confused_annoyed", "lord_test_expressions", "{=!}(confused_annoyed face)[if:convo_confused_annoyed]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_bored", "lord_expression_test_bored", "lord_test_expressions", "{=!}(uses convo_bored plus action)[ib:confident][if:convo_bored]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_bored2", "lord_expression_test_bored2", "lord_test_expressions", "{=!}(uses convo_bored2 plus action)[ib:confident2][if:convo_bored2]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_relaxed_happy", "lord_expression_test_relaxed_happy", "lord_test_expressions", "{=!}(relaxed happy face)[ib:closed][if:convo_relaxed_happy]", () => Game.Current.IsDevelopmentMode, null, 100, null);
			...
			starter.AddDialogLine("lord_expression_test_focused_happy", "lord_expression_test_focused_happy", "lord_test_expressions", "{=!}(focused happy face)[ib:closed2][if:convo_focused_happy]", () => Game.Current.IsDevelopmentMode, null, 100, null);
		...
		private void AddParleyDialogs(CampaignGameStarter starter)
		{
			...
			starter.AddPlayerLine("lord_barter_let_go", "lord_talk_speak_diplomacy_2", "lord_considers_letting_player_go", "{=ymuVaD4h}What would it take for you to go your way, and for me to go my way?", new ConversationSentence.OnConditionDelegate(this.conversation_player_can_bribe_lord_for_passage_on_condition), null, 100, null, null);
			starter.AddDialogLine("lord_considers_letting_player_go", "lord_considers_letting_player_go", "lord_pretalk", "{=Wpyr3Vts}{REFUSE_BARTER_LINE}", new ConversationSentence.OnConditionDelegate(this.conversation_lord_refuses_siege_lift_on_condition), null, 100, null);
			starter.AddDialogLine("lord_considers_letting_player_go", "lord_considers_letting_player_go", "lord_barter_pre_decision_safe_passage", "{=5bbvuAFf}What are you offering?", null, null, 100, null);
			starter.AddDialogLine("barter_decision_thinking", "lord_barter_pre_decision_safe_passage", "lord_barter_decision_safe_passage", "{=EPhBiTxd}Barter line - you should not see this.", null, new ConversationSentence.OnConsequenceDelegate(this.conversation_set_up_safe_passage_barter_on_consequence), 100, null);
		...
		private void AddHeroGeneralConversations(CampaignGameStarter starter)
		{
			...
			starter.AddDialogLine("hero_pretalk", "lord_pretalk", "hero_main_options", "{=DQBaaC0e}Is there anything else?", null, null, 100, null);
			...
			starter.AddPlayerLine("main_option_prisoner_interaction_list_prisoners_selected", "lord_talk_about_prisoners_list_prisoner_selected_final", "close_window", "{=g8qb3Ame}Thank you.", null, new ConversationSentence.OnConsequenceDelegate(this.lord_talk_to_selected_prisoner_on_consequence), 100, null, null);
			...
			starter.AddDialogLine("player_ask_lords_to_follow_him", "player_ask_lords_to_follow_him_answer", "how_many_days_to_escort", "{=2PPwmNmg}I can escort you for 10 days. After that, I must return to my own affairs.", new ConversationSentence.OnConditionDelegate(this.conversation_player_ask_lords_to_follow_him_on_condition), new ConversationSentence.OnConsequenceDelegate(this.conversation_player_ask_lords_to_follow_him_on_consequence), 100, null);
			...
			starter.AddPlayerLine("how_many_days_to_escort_never_mind", "how_many_days_to_escort", "lord_pretalk", "{=D33fIGQe}Never mind.", null, null, 100, null, null);
			...
			starter.AddDialogLine("player_want_to_join_faction_as_vassal_lord_answer", "lord_ask_enter_service", "lord_pretalk", "{=CVClzSC7}I believe you have already pledged yourself to another liege.", new ConversationSentence.OnConditionDelegate(this.conversation_player_is_asking_service_while_in_faction_on_condition), null, 100, null);
			...
			starter.AddDialogLine("player_want_to_join_faction_as_mercenary_king_answer", "lord_ask_enter_service_mercenary", "lord_pretalk", "{=AzmriKR8}I have hardly heard of you, {PLAYER.NAME}. Go fight a few bandits, make a name for yourself. Then we can talk.", new ConversationSentence.OnConditionDelegate(this.conversation_mercenary_service_offer_rejected_on_condition), null, 100, null);
			...
			starter.AddDialogLine("player_want_to_join_faction_as_mercenary_lord_answer", "lord_ask_enter_service_mercenary", "lord_pretalk", "{=9d3tffnL}We do not need hired swords to win this war. You should seek your fortune elsewhere.", () => FactionHelper.GetPowerRatioToEnemies((Kingdom)Hero.OneToOneConversationHero.MapFaction) > 3f, null, 100, null);
			starter.AddDialogLine("player_want_to_join_faction_as_mercenary_lord_answer", "lord_ask_enter_service_mercenary", "lord_ask_enter_service_mercenary_player_answer", "{=!}{MERCENARY_HIRING_PITCH}", new ConversationSentence.OnConditionDelegate(this.conversation_mercenary_hiring_pitch_on_condition), null, 100, null);
			...
			starter.AddDialogLine("lord_diagnostics_option_1", "lord_diagnostic_other_lords", "lord_diagnostics", "{=!}{OTHER_LORDS}", new ConversationSentence.OnConditionDelegate(this.conversation_cheat_other_lords_on_condition), null, 100, null);
			starter.AddPlayerLine("lord_diagnostics_option_1", "lord_diagnostic_options", "lord_diagnostic_enmities", "{=!}(CHEAT) Tell me about the enmities in your faction..", null, null, 100, null, null);
			starter.AddDialogLine("lord_diagnostics_option_1", "lord_diagnostic_enmities", "lord_diagnostics", "{=!}{ENMITY_INFO}", new ConversationSentence.OnConditionDelegate(this.conversation_cheat_faction_enmities_on_condition), null, 100, null);
			starter.AddPlayerLine("lord_diagnostics_option_1", "lord_diagnostic_options", "lord_diagnostic_reputation", "{=!}(CHEAT) Tell me about your personal reputation", null, null, 100, null, null);
			starter.AddDialogLine("lord_diagnostics_option_1", "lord_diagnostic_reputation", "lord_diagnostics", "{=!}{REPUTATION}", new ConversationSentence.OnConditionDelegate(this.conversation_cheat_reputation_on_condition), null, 100, null);
			starter.AddPlayerLine("lord_diagnostics_option_1", "lord_diagnostic_options", "lord_pretalk", "{=D33fIGQe}Never mind.", null, null, 100, null, null);
			...
			starter.AddPlayerLine("lord_talk_ask_something_2", "lord_talk_ask_something_2", "lord_tell_objective_1", "{=!}What are you and your men doing? (v1)", new ConversationSentence.OnConditionDelegate(this.debug_mode_enabled_condition), null, 100, null, null);
			starter.AddPlayerLine("lord_talk_ask_something_2", "lord_talk_ask_something_2", "wanderer_introduction_a", "{=Ymgbv2gV}What's your story again?", new ConversationSentence.OnConditionDelegate(this.conversation_wanderer_on_condition), null, 100, null, null);
			starter.AddPlayerLine("lord_talk_ask_something_2", "lord_talk_ask_something_2", "lord_pretalk", "{=D33fIGQe}Never mind.", null, null, 100, null, null);
			...
			starter.AddDialogLine("lord_tell_opinion_not_found", "lord_tell_opinion", "hero_main_options", "{=rao4bZBI}No, not really.", null, null, 100, null);
		...
		private void AddLordLiberateConversations(CampaignGameStarter starter)
		{
			...
			starter.AddPlayerLine("liberate_hero_10", "reprisoner_final_words", "liberate_comment", "{=kGg8xv4c}I changed my mind. You can go free.", null, null, 100, null, null);
			...
			starter.AddPlayerLine("talk_common_to_lord_liberate_player_yes_1", "liberate_response_enemy", "player_liberates_enemy", "{=BurJvC9s}Just get out of my sight.", null, new ConversationSentence.OnConsequenceDelegate(this.conversation_player_liberates_prisoner_on_consequence), 100, null, null);
		...
		private bool conversation_start_parley_on_condition()
		{
			...
			{
				return PlayerEncounter.EncounterSettlement.SiegeEvent.BesiegerCamp.GetInvolvedPartiesForEventType(5).Any((PartyBase party) => party.MobileParty == Hero.OneToOneConversationHero.PartyBelongedTo);
			}
			return false;
		}
		...
		private bool conversationUseMeetingDialogs()
		{
			...
			if (Campaign.Current.CurrentConversationContext != null && Campaign.Current.CurrentConversationContext != 3)
			{
				return false;
			}
		...
		private void conversations_automeet_close_relatives()
		{
			...
			{
				Debug.FailedAssert("player has not met with a family member", "C:\\Develop\\MB3\\Source\\Bannerlord\\SandBox\\CampaignBehaviors\\LordConversationsCampaignBehavior.cs", "conversations_automeet_close_relatives", 2668);
				Hero.OneToOneConversationHero.SetHasMet();
			}
		}
		...
		private bool conversation_lord_attacking_on_condition()
		{
			...
			if (Campaign.Current.CurrentConversationContext == 2 || Campaign.Current.CurrentConversationContext == 1 || Hero.OneToOneConversationHero.IsPrisoner)
			{
				return false;
			}
			this.conversations_set_voiced_line();
		...
		private bool conversation_lord_introduction_on_condition()
		{
			if (Hero.OneToOneConversationHero != null && Campaign.Current.ConversationManager.CurrentConversationIsFirst && Hero.OneToOneConversationHero.IsLord && !Hero.OneToOneConversationHero.IsMinorFactionHero && !Hero.OneToOneConversationHero.IsRebel && Hero.OneToOneConversationHero.Clan.MapFaction.IsKingdomFaction && Hero.OneToOneConversationHero != null)
			{
				...
				HeroHelper.SetPropertiesToTextObject(CharacterObject.OneToOneConversationCharacter.HeroObject, textObject, "CONVERSATION_CHARACTER");
				...
				if (Hero.OneToOneConversationHero.MapFaction.Leader != null)
				{
					...
					HeroHelper.SetPropertiesToTextObject(Hero.OneToOneConversationHero.MapFaction.Leader, textObject2, "LEADER");
		...
		private bool conversation_rebel_introduction_on_condition()
		{
			if (Hero.OneToOneConversationHero != null && Campaign.Current.ConversationManager.CurrentConversationIsFirst && Hero.OneToOneConversationHero.IsRebel)
			{
				...
				HeroHelper.SetPropertiesToTextObject(Hero.OneToOneConversationHero, textObject, "CONVERSATION_HERO");
		...
		private bool conversation_merchant_introduction_on_condition()
		{
			if (Campaign.Current.ConversationManager.CurrentConversationIsFirst && Hero.OneToOneConversationHero.IsMerchant)
			{
				...
				if (Hero.OneToOneConversationHero.HomeSettlement.IsTown)
				{
					...
					IEnumerable<Workshop> enumerable = Extensions.DistinctBy<Workshop, WorkshopType>(Hero.OneToOneConversationHero.OwnedWorkshops, (Workshop x) => x.WorkshopType);
		...
		private bool conversation_wanderer_preintroduction_on_condition()
		{
			...
			if (characterObject != null && characterObject != Hero.OneToOneConversationHero.CharacterObject)
			{
				...
				GameTexts.TryGetText("generic_backstory", ref textObject2, stringId);
				if (textObject2 == null)
				{
		...
		private bool conversation_lord_makes_comment_on_condition()
		{
			if (this.lord_comments())
			{
				int num;
				string text;
				Campaign.Current.LogEntryHistory.GetRelevantComment(Hero.OneToOneConversationHero, ref num, ref text);
				if (num > 0)
				{
		...
		private bool conversation_hero_main_options_have_issue_on_clickable_condition(out TextObject hint)
		{
			...
			IssueBase issueBase;
			Campaign.Current.IssueManager.Issues.TryGetValue(hero, ref issueBase);
		...
		private bool conversation_player_can_attack_hero_on_clickable_condition(out TextObject hint)
		{
			...
			if (encounteredMobileParty != null && encounteredMobileParty.MapFaction != null && DiplomacyHelper.DidMainHeroSwornNotToAttackFaction(encounteredMobileParty.MapFaction, ref hint))
			{
				return false;
			}
			hint = TextObject.Empty;
		...
		public bool conversation_player_is_offering_mercenary_on_clickable_condition(out TextObject hintText)
		{
			List<IFaction> list;
			List<IFaction> list2;
			bool flag = FactionHelper.CanPlayerOfferMercenaryService((Kingdom)Hero.OneToOneConversationHero.MapFaction, ref list, ref list2);
			...
			if (!flag)
			{
				...
				else if (!Extensions.IsEmpty<Settlement>(Clan.PlayerClan.Settlements))
				{
				...
				TextObjectExtensions.SetCharacterProperties(hintText, "HERO", Hero.OneToOneConversationHero.CharacterObject, false);
		...
		public bool conversation_player_is_offering_vassalage_on_clickable_condition(out TextObject hintText)
		{
			List<IFaction> list;
			List<IFaction> list2;
			bool flag = FactionHelper.CanPlayerOfferVassalage((Kingdom)Hero.OneToOneConversationHero.MapFaction, ref list, ref list2);
			hintText = new TextObject("", null);
			if (!flag)
			{
		...
		public bool conversation_player_want_to_end_service_as_mercenary_on_condition()
		{
			...
			if (Hero.OneToOneConversationHero.MapFaction.IsKingdomFaction)
			{
				MBTextManager.SetTextVariable("FACTION_NAME", FactionHelper.GetFormalNameForFactionCulture(Hero.OneToOneConversationHero.Clan.Kingdom.Culture), false);
			}
		...
		public bool conversation_lord_tell_objective_besiege_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && (partyBelongedTo.DefaultBehavior == 5 || (partyBelongedTo.DefaultBehavior == 14 && partyBelongedTo.TargetParty.DefaultBehavior == 5)))
				{
					if (partyBelongedTo.DefaultBehavior == 14)
					{
		...
		public bool conversation_lord_tell_objective_defence_village_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && ((partyBelongedTo.DefaultBehavior == 15 && partyBelongedTo.TargetSettlement.IsVillage) || (partyBelongedTo.DefaultBehavior == 14 && partyBelongedTo.TargetParty.DefaultBehavior == 15 && partyBelongedTo.TargetParty.TargetSettlement.IsVillage)))
				{
					if (partyBelongedTo.DefaultBehavior == 14)
					{
		...
		public bool conversation_lord_tell_objective_defence_town_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && ((partyBelongedTo.DefaultBehavior == 15 && partyBelongedTo.TargetSettlement.IsFortification) || (partyBelongedTo.DefaultBehavior == 14 && partyBelongedTo.TargetParty.DefaultBehavior == 15 && partyBelongedTo.TargetParty.TargetSettlement.IsFortification)))
				{
					if (partyBelongedTo.DefaultBehavior == 14)
					{
						MBTextManager.SetTextVariable("TARGET_TOWN", partyBelongedTo.TargetParty.TargetSettlement.Name, false);
		...
		public bool conversation_lord_tell_objective_patrolling_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && (partyBelongedTo.DefaultBehavior == 13 || (partyBelongedTo.DefaultBehavior == 14 && partyBelongedTo.TargetParty.DefaultBehavior == 13)))
				{
					if (partyBelongedTo.DefaultBehavior == 14)
					{
		...
		public bool conversation_lord_tell_objective_waiting_for_siege_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && partyBelongedTo.Army != null && partyBelongedTo.Army.ArmyType == null && partyBelongedTo.Army.AIBehavior == 3)
				{
		...
		public bool conversation_lord_tell_objective_waiting_for_defence_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && partyBelongedTo.Army != null && partyBelongedTo.Army.ArmyType == 2 && partyBelongedTo.Army.AIBehavior == 3)
				{
		...
		public bool conversation_lord_tell_objective_raiding_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && (partyBelongedTo.DefaultBehavior == 4 || (partyBelongedTo.DefaultBehavior == 14 && partyBelongedTo.TargetParty.DefaultBehavior == 4)))
				{
					if (partyBelongedTo.DefaultBehavior == 14)
					{
						MBTextManager.SetTextVariable("TARGET_VILLAGE", partyBelongedTo.TargetParty.TargetSettlement.Name, false);
		...
		public bool conversation_lord_tell_objective_waiting_for_raid_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && partyBelongedTo.Army != null && partyBelongedTo.Army.ArmyType == 1 && partyBelongedTo.Army.AIBehavior == 3)
				{
		...
		public bool conversation_lord_tell_objective_gathering_on_condition()
		{
			...
			{
				MobileParty partyBelongedTo = Hero.OneToOneConversationHero.PartyBelongedTo;
				if (partyBelongedTo != null && partyBelongedTo.Army != null && partyBelongedTo.Army.AIBehavior == 2)
				{
		...
		public bool conversation_lord_answers_the_location_on_condition()
		{
			...
			if (partyBelongedTo)
			{
				foreach (Settlement settlement2 in list)
				{
					...
					float num2;
					if (Campaign.Current.Models.MapDistanceModel.GetDistance(ConversationHelper.AskedLord.HeroObject.PartyBelongedTo, settlement2, num, ref num2))
					{
