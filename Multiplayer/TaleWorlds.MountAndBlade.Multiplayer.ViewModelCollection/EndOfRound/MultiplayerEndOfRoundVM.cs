...
namespace TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.EndOfRound
{
	public class MultiplayerEndOfRoundVM : ViewModel
	{
		public MultiplayerEndOfRoundVM(MissionScoreboardComponent scoreboardComponent, MissionLobbyComponent missionLobbyComponent, IRoundComponent multiplayerRoundComponent)
		{
			...
			if (this._missionLobbyComponent.MissionType == 4 || this._missionLobbyComponent.MissionType == 5 || this._missionLobbyComponent.MissionType == 6)
			{
		...
		public void Refresh()
		{
			BattleSideEnum allyBattleSide = -1;
			...
			BattleSideEnum battleSideEnum = ((allyBattleSide == 1) ? 0 : 1);
			...
			MissionScoreboardComponent.MissionScoreboardSide missionScoreboardSide = this._scoreboardComponent.Sides.FirstOrDefault((MissionScoreboardComponent.MissionScoreboardSide s) => s != null && s.Side == 1);
			MissionScoreboardComponent.MissionScoreboardSide missionScoreboardSide2 = this._scoreboardComponent.Sides.FirstOrDefault((MissionScoreboardComponent.MissionScoreboardSide s) => s != null && s.Side == 0);
			bool flag = this._multiplayerRoundComponent.RoundWinner == 1;
			bool flag2 = this._multiplayerRoundComponent.RoundWinner == 0;
			Team team = missionPeer.Team;
			if (team != null && team.Side == 1)
			{
