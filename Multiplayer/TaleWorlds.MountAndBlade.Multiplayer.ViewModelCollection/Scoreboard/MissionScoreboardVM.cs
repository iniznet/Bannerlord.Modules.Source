...
namespace TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Scoreboard
{
	public class MissionScoreboardVM : ViewModel
	{
		...
		{
			MissionScoreboardPlayerVM missionScoreboardPlayerVM = playerObj as MissionScoreboardPlayerVM;
			this._missionPollComponent.RequestKickPlayerPoll(PeerExtensions.GetNetworkPeer(missionScoreboardPlayerVM.Peer), false);
		}
		...
		private bool IsSideValid(BattleSideEnum side)
		{
			...
			{
				return this._missionScoreboardComponent != null && side != -1 && side != 2;
			}
			return this._missionScoreboardComponent != null && side != -1 && side != 2 && this._missionScoreboardComponent.Sides.Any((MissionScoreboardComponent.MissionScoreboardSide s) => s != null && s.Side == side);
		}
		...
		private void InitSides()
		{
			...
			if (this.IsSingleSide)
			{
				MissionScoreboardComponent.MissionScoreboardSide sideSafe = this._missionScoreboardComponent.GetSideSafe(0);
			...
			BattleSideEnum firstSideToAdd = 1;
			BattleSideEnum secondSideToAdd = 0;
			if (missionPeer != null)
			{
