...
namespace TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby.AfterBattle
{
	public class MPAfterBattlePopupVM : ViewModel
	{
		...
		private void ShowGeneralProgression()
		{
			...
			playerDataExperience..ctor(this._oldExperience);
			PlayerDataExperience playerDataExperience2;
			playerDataExperience2..ctor(this._newExperience);
		...
		private void ShowRankProgression()
		{
			...
			else
			{
				...
				this.FinalRatio = (int)this._newRankBarInfo.ProgressPercentage;
				this.NumOfLevelUps = ((Extensions.IndexOf<string>(Ranks.RankIds, this.OldRankID) < Extensions.IndexOf<string>(Ranks.RankIds, this.NewRankID)) ? 1 : 0);
		...
		private void ShowRankChange()
		{
			...
			{
				this.TitleText = ((Extensions.IndexOf<string>(Ranks.RankIds, this.OldRankID) < Extensions.IndexOf<string>(Ranks.RankIds, this.NewRankID)) ? this._promotedTitleText : this._demotedTitleText);
