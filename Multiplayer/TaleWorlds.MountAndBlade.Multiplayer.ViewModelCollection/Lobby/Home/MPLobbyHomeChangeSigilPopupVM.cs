...
namespace TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby.Home
{
	public class MPLobbyHomeChangeSigilPopupVM : ViewModel
	{
		...
		private void RefreshSigilList()
		{
			...
			{
				if (cosmeticElementsList[i].Type == 2)
				{
					SigilCosmeticElement sigilCosmeticElement = cosmeticElementsList[i] as SigilCosmeticElement;
					MPLobbyCosmeticSigilItemVM mplobbyCosmeticSigilItemVM = new MPLobbyCosmeticSigilItemVM(new Banner(sigilCosmeticElement.BannerCode).BannerDataList[1].MeshId, sigilCosmeticElement.Rarity, sigilCosmeticElement.Cost, sigilCosmeticElement.Id);
