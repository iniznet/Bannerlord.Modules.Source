...
namespace TaleWorlds.MountAndBlade.Multiplayer.ViewModelCollection.Lobby.CustomGame
{
	public class MPCustomGameFiltersVM : ViewModel
	{
		...
		{
			return ModuleInfoModelExtensions.IsCompatibleWith(NetworkMain.GameClient.LoadedUnofficialModules, serverEntry.LoadedModules, serverEntry.AllowsOptionalModules);
		}
