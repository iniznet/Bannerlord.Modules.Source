	...
	public class MPPlayerVM : ViewModel
	{
		...
		public MPPlayerVM(Agent agent)
		{
			if (agent != null)
			{
				...
				TargetIconType targetIconType = ((mpheroClassForCharacter != null) ? mpheroClassForCharacter.IconType : (-1));
			...
			this.CompassElement = new MPTeammateCompassTargetVM(0, 0U, 0U, BannerCode.CreateFrom(Banner.CreateOneColoredEmptyBanner(0)), false);
		}
		...
		public MPPlayerVM(MissionPeer peer)
		{
			...
			if (this.Peer == null)
			{
				this.CompassElement = new MPTeammateCompassTargetVM(-1, 0U, 0U, null, false);
				return;
			}
		...
		{
			bool flag = MultiplayerOptionsExtensions.GetIntValue(20, 0) > 0;
		...
		private ImageIdentifierVM _avatar = new ImageIdentifierVM(0);
