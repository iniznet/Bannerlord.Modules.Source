...
namespace TaleWorlds.MountAndBlade.Multiplayer.GauntletUI.Mission
{
	...
	public class MissionGauntletMultiplayerOrderUIHandler : MissionView
	{
		...
		private void OnManagedOptionChanged(ManagedOptions.ManagedOptionsType changedManagedOptionsType)
		{
			...
			else if (changedManagedOptionsType == 34)
			{
				MissionOrderVM dataSource = this._dataSource;
				if (dataSource == null)
				{
		...
		private void TickInput(float dt)
		{
			...
			if (this._dataSource.IsToggleOrderShown)
			{
				...
				{
					OrderItemVM lastSelectedOrderItem = this._dataSource.LastSelectedOrderItem;
					if (lastSelectedOrderItem != null && !lastSelectedOrderItem.IsTitle && Input.IsGamepadActive)
					{
					...
					else
					{
						...
						case 2:
							...
							break;
						default:
							Debug.FailedAssert("false", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer.GauntletUI\\Mission\\MissionGauntletMultiplayerOrderUIHandler.cs", "TickInput", 560);
							break;
						}
					}
				}
			...
			int num = -1;
			if ((!Input.IsGamepadActive || this._dataSource.IsToggleOrderShown) && !base.DebugInput.IsControlDown())
			{
