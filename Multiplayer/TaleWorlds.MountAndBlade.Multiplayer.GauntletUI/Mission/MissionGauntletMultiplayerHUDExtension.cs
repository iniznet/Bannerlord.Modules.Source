...
namespace TaleWorlds.MountAndBlade.Multiplayer.GauntletUI.Mission
{
	...
	public class MissionGauntletMultiplayerHUDExtension : MissionView
	{
		...
		public override void OnMissionScreenInitialize()
		{
			...
			base.MissionScreen.OnSpectateAgentFocusIn += new MissionScreen.OnSpectateAgentDelegate(this._dataSource.OnSpectatedAgentFocusIn);
			base.MissionScreen.OnSpectateAgentFocusOut += new MissionScreen.OnSpectateAgentDelegate(this._dataSource.OnSpectatedAgentFocusOut);
