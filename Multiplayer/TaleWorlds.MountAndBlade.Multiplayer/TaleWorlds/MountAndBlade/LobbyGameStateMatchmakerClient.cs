...
namespace TaleWorlds.MountAndBlade
{
	public sealed class LobbyGameStateMatchmakerClient : LobbyGameState
	{
		...
		{
			base.OnActivate();
			if (this._gameClient != null && (this._gameClient.CurrentState == 4 || this._gameClient.CurrentState == 10 || !this._gameClient.Connected))
			{
		...
		protected override void StartMultiplayer()
		{
			...
			BannerlordNetwork.StartMultiplayerLobbyMission(0);
