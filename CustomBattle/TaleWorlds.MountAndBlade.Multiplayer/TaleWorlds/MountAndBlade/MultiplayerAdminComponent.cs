...
namespace TaleWorlds.MountAndBlade
{
	public class MultiplayerAdminComponent : MissionNetwork
	{
		...
		public void OnApplySettings()
		{
			...
			GameNetwork.EndBroadcastModuleEvent(0, null);
		}
				...
				if (!peerToKick.IsMine)
				{
					...
					if (component != null)
					{
						if (banPlayer)
						{
							...
							{
								BannedPlayerManagerCustomGameServer.AddBannedPlayer(component.Peer.Id, PeerExtensions.GetNetworkPeer(component).UserName, GameNetwork.IsDedicatedServer ? (-1) : (Environment.TickCount + 600000));
							}
						}
