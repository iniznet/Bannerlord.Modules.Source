	...
	public class MeetWithIstianaQuest : StoryModeQuestBase
	{
		...
		protected override void SetDialogs()
		{
			Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("lord_start", 110).NpcLine(new TextObject("{=5UHbg6D0}So. What brings you to me?", null), null, null).Condition(() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero == StoryModeHeroes.ImperialMentor && !this._metImperialMentor)
				...
				.NpcLine(new TextObject("{=KXj8bsao}So... If you intend to use the banner to save the Empire, I'll tell you what I know. But if you want to go backward, not forward, then I will not help you.[ib:closed][if:convo_undecided_closed]", null), null, null)
				...
				.NpcLine(new TextObject("{=FHM5GcHW}Good. Then I will tell you what I know. I heard about one other piece.[ib:normal2][if:convo_calm_friendly]", null), null, null)
				...
				.NpcLine(new TextObject("{=5D5lOHSL}When you have recovered all pieces, return to me and I'll help you put them to use.[if:convo_calm_friendly]", null), null, null)
				...
				.NpcLine(new TextObject("{=TH6L7OXu}Then you can come back when you have made up your mind.[ib:demure][if:convo_snide_voice]", null), null, null)
				.CloseDialog()
				.EndPlayerOptions()
				.CloseDialog(), this);
			Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("lord_start", 110).NpcLine(new TextObject("{=oaSTbNwz}So have you made up your mind now?", null), null, null).Condition(() => Hero.OneToOneConversationHero != null && Hero.OneToOneConversationHero == StoryModeHeroes.ImperialMentor && this._metImperialMentor)
				...
				.NpcLine(new TextObject("{=1CLNFbzR}Good. Then I will tell you what I know. I heard about one other piece.[ib:normal2][if:convo_calm_friendly]", null), null, null)
				...
				.NpcLine(new TextObject("{=PknruSY5}Then you can come back when you have made up your mind.[ib:demure][if:convo_nonchalant]", null), null, null)
				.CloseDialog()
				.EndPlayerOptions()
				.CloseDialog(), this);
		}
