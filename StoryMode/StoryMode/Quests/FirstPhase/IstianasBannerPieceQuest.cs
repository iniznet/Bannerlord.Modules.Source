...
namespace StoryMode.Quests.FirstPhase
{
	public class IstianasBannerPieceQuest : StoryModeQuestBase
	{
		...
		{
			MobileParty mobileParty = BanditPartyComponent.CreateBanditParty("istiana_banner_piece_quest_raider_party_" + number, this._hideout.OwnerClan, this._hideout.Hideout, false);
